...
#define GLADE_HOOKUP_OBJECT_NO_REF(component,widget,name) \
  ...
  GtkWidget *webcamImage;  GtkWidget *userDetails;  GtkWidget *userList;  GtkWidget *removeUser;  GtkWidget *userFace;
GtkWidget*
create_faceManager (void)
{
  ...
  gboolean f=0;
  gtk_window_set_resizable (faceManager,f);
  ...
  gtk_box_pack_start (GTK_BOX (vbox2), webcamImage, FALSE, FALSE, 0);
  ...
  assign = gtk_button_new_with_mnemonic (_("Capture Face & Assign to User"));
  ...
  label1 = gtk_label_new (_("<b>Selected User Details</b>"));
  ...
  GtkWidget *userNamePrompt;  GtkWidget *username;
GtkWidget*
