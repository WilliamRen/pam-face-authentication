...
pam_face_authenticate_so_DEPENDENCIES = $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) libfacedetect.la libfaceauthenticate.la
...
ACLOCAL = ${SHELL} /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only/missing --run aclocal-1.10
AMTAR = ${SHELL} /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only/missing --run autoconf
AUTOHEADER = ${SHELL} /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only/missing --run autoheader
AUTOMAKE = ${SHELL} /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only/missing --run automake-1.10
AWK = gawk
CC = gcc
...
GTK_CFLAGS = -I/usr/local/include/glib-2.0 -I/usr/local/lib/glib-2.0/include -I/usr/include/gtk-2.0 -I/usr/lib/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/freetype2 -I/usr/include/libpng12  
GTK_LIBS = -L/usr/local/lib -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgdk_pixbuf-2.0 -lpangocairo-1.0 -lpango-1.0 -lcairo -lgobject-2.0 -lgmodule-2.0 -ldl -lglib-2.0  
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
OPENCV_CFLAGS = -I/opencv_library_install_path/opencv-1.0.0/include/opencv  
OPENCV_LIBS = -L/opencv_library_install_path/opencv-1.0.0/lib -lcxcore -lcv -lhighgui -lcvaux -lml  
...
STRIP = strip
VERSION = 0.2
abs_builddir = /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only
abs_srcdir = /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only
abs_top_builddir = /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only
abs_top_srcdir = /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_F77 = 
am__include = include
...
install_sh = $(SHELL) /home/darksid3hack0r/Desktop/PAMFACE/pam-face-authentication-read-only/install-sh
...
install-extraLTLIBRARIES: $(extra_LTLIBRARIES)
	...
	@list='$(extra_LTLIBRARIES)'; for p in $$list; do \
	  if test -f $$p; then \
	    f=$(am__strip_dir) \
	    echo " $(LIBTOOL) --mode=install $(extraLTLIBRARIES_INSTALL) $(INSTALL_STRIP_FLAG) '$$p' '$(DESTDIR)$(extradir)/$$f'"; \
	    $(LIBTOOL) --mode=install $(extraLTLIBRARIES_INSTALL) $(INSTALL_STRIP_FLAG) "$$p" "$(DESTDIR)$(extradir)/$$f"; \
	  else :; fi; \
	done
...
uninstall-extraLTLIBRARIES:
	...
	@list='$(extra_LTLIBRARIES)'; for p in $$list; do \
	  p=$(am__strip_dir) \
	  echo " $(LIBTOOL) --mode=uninstall rm -f '$(DESTDIR)$(extradir)/$$p'"; \
...
install-pammodPROGRAMS: $(pammod_PROGRAMS)
	...
	@list='$(pammod_PROGRAMS)'; for p in $$list; do \
	  ...
	  ; then \
	    f=`echo "$$p1" | sed 's,^.*/,,;$(transform);s/$$/$(EXEEXT)/'`; \
	   echo " $(INSTALL_PROGRAM_ENV) $(LIBTOOL) --mode=install $(pammodPROGRAMS_INSTALL) '$$p' '$(DESTDIR)$(pammoddir)/$$f'"; \
	   $(INSTALL_PROGRAM_ENV) $(LIBTOOL) --mode=install $(pammodPROGRAMS_INSTALL) "$$p" "$(DESTDIR)$(pammoddir)/$$f" || exit 1; \
	  else :; fi; \
	done
