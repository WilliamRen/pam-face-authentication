...
char *XAUTH_EXTRACT_COMMAND1=".Xauth -b list>/etc/pam_face_authentication/xauth.key";
char* XAUTH_DISPLAY_EXTRACT_COMMAND="echo $DISPLAY >/etc/pam_face_authentication/display.key";
