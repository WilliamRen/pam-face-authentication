        ...
        for (;;)
        {
            ...
            if (AuthenticateButtonClicked==1)
            {
                ...
                else
                {
                    ...
                    cvPutText(frame_copy,"NO PROPER DETECTION, TRY AGAIN!", cvPoint(26,15),&myFont, CV_RGB(255,255,255));

                }
                cvFillConvexPoly(frame_copy, pts,4,CV_RGB(0,140,0),CV_AA,0 );
                cvPutText(frame_copy,"AUTHENTICATION FAILED!", cvPoint(60,15),&myFont, CV_RGB(255,255,255));
